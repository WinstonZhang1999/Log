...
#listcfgs = c("P1_GB.txt","P2_PB.txt","P3_JB.txt","P2a_GB.txt","P4_NU.txt",
#             "P5_BP.txt","P4a_GB.txt","P8_CD.txt", "P7_FR.txt")
listcfgs = c("P1_tp.txt","P2_wb.txt")
#listcfgs = c("L1.txt","L2.txt","L3.txt","L4.txt","L5.txt","L6.txt","L7.txt")
#listcfgs = c("L1.txt","L2.txt","L3.txt","L4.txt","L5.txt")
for(x in 1 : length(listcfgs))
{
idxFile = x

#pathConfigs = paste("/Users/winston/Documents/DigitalFood/DigitalFood_Slicer/scripts/configs/combo_7/",listcfgs[idxFile],sep="")  
pathConfigs = paste("/Users/winston/Documents/DigitalFood/DigitalFood_Slicer/scripts/configs/Chile/",listcfgs[idxFile],sep="")
#pathConfigs = paste("/home/shravan/Columbia/Sem_1/Food_3D/Sli3r/scripts/configs/burrito/",listcfgs[idxFile],sep="")
#pathConfigs = paste("/home/shravan/Columbia/Sem_1/Food_3D/Sli3r/scripts/configs/offset/",listcfgs[idxFile],sep="")
...
fileDrop = paste("/Users/winston/Documents/DigitalFood/DigitalFood_Slicer/toolchange/tool_drop_",dropSlot,".gcode",sep = "")
filePick = paste("/Users/winston/Documents/DigitalFood/DigitalFood_Slicer/toolchange/tool_pick_",pickSlot,".gcode",sep = "")
